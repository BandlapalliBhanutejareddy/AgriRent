...
async function generateWebExcelReport() {
  ...
  const sheet = workbook.addWorksheet('Web Test Results');
  ...
  const outputPath = path.join(reportsDir, 'Web_Selenium_Test_Report.xlsx');
...
module.exports = { generateWebExcelReport };
