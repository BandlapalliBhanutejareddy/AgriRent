    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top']}>
      ...
      >
        <View style={styles.header}>
            <View>
                <Text style={[typography.h1, { color: theme.text }]}>Insights</Text>
                <Text style={[typography.bodySmall, { color: theme.textSecondary, marginTop: 4 }]}>Manage your farming fleet</Text>
            </View>
        ...
        <View style={styles.section}>
            <View style={styles.sectionHeader}>
                <Text style={[typography.h2, { color: theme.text }]}>Earnings</Text>
                <TouchableOpacity><Text style={[typography.label, { color: theme.primary }]}>VIEW ALL</Text></TouchableOpacity>
            </View>
            <View style={[styles.chartBox, { backgroundColor: theme.card, borderColor: theme.border }]}>
                <View style={styles.chartHeader}>
                    <BarChart3 size={18} color={theme.primary} />
                    <Text style={[typography.title, { color: theme.text, marginLeft: 10 }]}>Revenue Growth</Text>
                </View>
        ...
        <View style={styles.section}>
            <Text style={[typography.h2, { color: theme.text, marginBottom: 20 }]}>Quick Actions</Text>
            <View style={styles.actionRow}>
                ...
                >
                    ...
                    <Text style={[typography.title, { color: theme.text, marginTop: 12 }]}>Add Unit</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.actionCard, { backgroundColor: theme.card }]}>
                    <Users size={24} color={theme.primary} />
                    <Text style={[typography.title, { color: theme.text, marginTop: 12 }]}>Farmers</Text>
                </TouchableOpacity>
            </View>
        </View>
