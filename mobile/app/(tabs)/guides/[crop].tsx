  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={[typography.h3, { color: theme.text, textTransform: 'capitalize' }]}>{crop} Guide</Text>
        <View style={{ width: 48 }} />
      </View>
        ...
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateX: slideAnim }] }}>
            <View style={styles.heroContainer}>
                ...
                <View style={styles.progressBox}>
                    <Text style={styles.progressText}>STEP {currentStep + 1} / {steps.length}</Text>
                </View>
            </View>
            ...
            <View style={styles.contentSection}>
                ...
                <View style={[styles.tipBox, { backgroundColor: theme.primary + '05', borderColor: theme.primary + '15' }]}>
                    <View style={styles.tipHeader}>
                        ...
                        <Text style={[typography.title, { color: theme.primary, marginLeft: 10 }]}>Pro Tip</Text>
                    </View>
                ...
                <View style={styles.toolkitSection}>
                    <Text style={[typography.label, { color: theme.textMuted, marginBottom: 16 }]}>REQUIRED TOOL</Text>
                    <TouchableOpacity 
