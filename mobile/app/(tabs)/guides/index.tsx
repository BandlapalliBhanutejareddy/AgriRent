  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={[typography.h1, { color: theme.text }]}>Learning</Text>
        <View style={{ width: 44 }} />
      </View>
      ...
      >
            ...
            >
                <View style={styles.featuredContent}>
                    <View style={styles.playBadge}>
                        ...
                        <Text style={styles.playText}>WATCH LESSON</Text>
                    </View>
        ...
        {/* Premium Grid */}
        <View style={styles.section}>
          <Text style={[typography.h2, { color: theme.text, marginBottom: spacing.xl }]}>Masterclasses</Text>
            ...
            {CROPS.map((crop) => (
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.lessonCount}>{crop.steps} Steps</Text>
                </LinearGradient>
              </TouchableOpacity>
            ))}
          </View>
        ...
        >
            ...
            <View style={{ flex: 1, marginLeft: 16 }}>
                <Text style={[typography.title, { color: theme.text }]}>AI Advisor</Text>
                <Text style={[typography.caption, { color: theme.textSecondary }]}>Personalized tools for your farm</Text>
            </View>
